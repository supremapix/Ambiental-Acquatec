      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {SERVICES.map((service) => (
            <div key={service.id} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a 
                    href="#orcamento"
                    className="block w-full text-center bg-brand-orange text-white font-bold py-3 rounded hover:bg-orange-600 transition-colors"
                  >
                    {service.cta}
                  </a>
                </div>
